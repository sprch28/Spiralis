...
#else // ___SP_SIMD_LEVEL___ == 10
    // Expose the public macros
    #define _SP_LOOP_NOLOAD_SIMD_1_(op)
    #define _SP_LOOP_SIMD_2_(op)
    #define _SP_LOOP_SIMD_3_(op)
    #define _SP_LOOP_CMP_SIMD_2_(op)
    #define _SP_LOOP_SEL_SIMD_3_(op)
    #define _SP_LOOP_SEL_EXPL_SIMD_3_(op)
#endif
